      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 bottom-0 w-80 bg-white dark:bg-slate-900 z-50 md:hidden shadow-xl"
          >
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `block px-4 py-3 rounded-lg text-sm font-medium transition-colors ${
                        isActive
                          ? "bg-accent-light dark:bg-slate-800 text-accent dark:text-accent-dark"
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 dark:border-slate-700">
                <div className="flex justify-center gap-4">
                  <a
                    ...
                    className="p-3 rounded-full bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-300 hover:text-accent dark:hover:text-accent-dark transition-colors"
                  >
                    <Github size={20} />
                  </a>
                  <a
