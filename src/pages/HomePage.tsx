        ...
        <motion.section variants={itemVariants}>
          ...
          <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed space-y-4">
            <motion.p variants={itemVariants} className="m-0">
              ...
              <a href="https://vision.ischool.illinois.edu/index.html" className="font-medium text-[#5B9AA9] hover:text-[#5B9AA9]/80 hover:no-underline">
                Computer Vision and Machine Learning Group
              </a>{" "}
              at{" "}
              <a href="https://www.illinois.edu/" className="font-medium text-[#5B9AA9] hover:text-[#5B9AA9]/80 hover:no-underline">
                University of Illinois Urbana-Champaign
              </a>
              . I am also affiliated with the{" "}
              <a href="https://www.ncsa.illinois.edu/" className="font-medium text-[#5B9AA9] hover:text-[#5B9AA9]/80 hover:no-underline">
                National Center for Supercomputing Applications
              </a>{" "}
              and{" "}
              <a href="https://nairrpilot.org/" className="font-medium text-[#5B9AA9] hover:text-[#5B9AA9]/80 hover:no-underline">
